...
<div class="section theme-green">
    ...
    <div class="req-grid">
        <div class="req-pill"><span class="num">1</span><div class="fr-content"><div class="fr-en">Send Push Notifications (FCM / APNs)</div><div class="fr-hi">Ye sabse common delivery channel hai — user app band karke chala gaya toh bhi phone pe push notification aaye. FCM Android ke liye aur APNs iOS ke liye use hota hai, dono ko support karna zaroori hai</div></div></div>
        <div class="req-pill"><span class="num">2</span><div class="fr-content"><div class="fr-en">Send Email Notifications (SMTP / SES)</div><div class="fr-hi">Email channel isliye zaroori hai ki formal communication ke liye — order confirmations, invoices, password reset jaise important notifications email se hi jaate hai. Push notification miss ho sakti hai, lekin email permanent record rehta hai</div></div></div>
        <div class="req-pill"><span class="num">3</span><div class="fr-content"><div class="fr-en">Send SMS Notifications (Twilio / SNS)</div><div class="fr-hi">SMS isliye chahiye ki OTP verification aur critical alerts ke liye — user ke paas internet na ho toh bhi SMS aa jaata hai. Banking OTP, login verification jaise use cases me SMS irreplaceable hai</div></div></div>
        <div class="req-pill"><span class="num">4</span><div class="fr-content"><div class="fr-en">In-App Notification Center</div><div class="fr-hi">Ye feature isliye hai taki user app ke andar apni saari notifications ek jagah dekh sake — bell icon pe click kare toh saari recent activities dikhe. Push notification dismiss ho gayi toh bhi yahan se accessible rahe</div></div></div>
        <div class="req-pill"><span class="num">5</span><div class="fr-content"><div class="fr-en">Template Engine (dynamic placeholders)</div><div class="fr-hi">Har notification me hardcoded text likhna impractical hai — template engine se ek baar template banaao aur {{userName}}, {{orderID}} jaise placeholders dynamically fill ho jaaye. 10 lakh users ko personalized message bhejna isse easy ho jaata hai</div></div></div>
        <div class="req-pill"><span class="num">6</span><div class="fr-content"><div class="fr-en">Priority-based Delivery (urgent / normal / low)</div><div class="fr-hi">Saari notifications same priority ki nahi hoti — OTP 30 seconds me pohochna chahiye lekin promotional email 5 minute late bhi chalega. Priority queue se urgent messages pehle process hote hai aur system overload me bhi critical alerts delay nahi hote</div></div></div>
        <div class="req-pill"><span class="num">7</span><div class="fr-content"><div class="fr-en">Retry with Exponential Backoff</div><div class="fr-hi">Network issues ya provider downtime se notification fail ho sakti hai — retry karna zaroori hai lekin immediately retry karne se provider pe aur load padega. Exponential backoff se 1s, 2s, 4s, 8s wait karke smartly retry hota hai</div></div></div>
        <div class="req-pill"><span class="num">8</span><div class="fr-content"><div class="fr-en">User Preferences (opt-in / opt-out per channel)</div><div class="fr-hi">Har user ko har channel pe notification nahi chahiye — kisi ko sirf email chahiye, kisi ko sirf push. Bina preferences ke user annoyed hoke notifications band kar dega ya app uninstall kar dega. GDPR compliance ke liye bhi opt-in/out zaroori hai</div></div></div>
        <div class="req-pill"><span class="num">9</span><div class="fr-content"><div class="fr-en">Rate Limiting per User</div><div class="fr-hi">Agar ek user ko 1 ghante me 50 notifications bhej di toh woh irritate hoke sab band kar dega — rate limiting se per user per channel limit set hoti hai jaise max 5 push/hour, taki user experience kharab na ho</div></div></div>
        <div class="req-pill"><span class="num">10</span><div class="fr-content"><div class="fr-en">Scheduled &amp; Batch Notifications</div><div class="fr-hi">Marketing team ko Monday 10 AM pe campaign notification bhejni hai — scheduled notifications se future time pe set kar sakte hai. Batch mode se 1 million users ko efficiently ek saath notification bheji ja sakti hai bina system overload ke</div></div></div>
        <div class="req-pill"><span class="num">11</span><div class="fr-content"><div class="fr-en">Read / Unread Tracking</div><div class="fr-hi">Ye tracking isliye zaroori hai taki user ko pata chale kitni unread notifications hai — bell icon pe red badge dikhe. Aur analytics ke liye bhi important hai ki kitne percent users actually notification padhte hai</div></div></div>
        <div class="req-pill"><span class="num">12</span><div class="fr-content"><div class="fr-en">Dead Letter Queue for Failed Deliveries</div><div class="fr-hi">Agar 3-4 baar retry ke baad bhi notification deliver nahi hui toh usse DLQ me daalna padega — warna main queue block ho jaayegi. DLQ se engineering team manually investigate karke fix kar sakti hai bina system halt ke</div></div></div>
    </div>
</div>
