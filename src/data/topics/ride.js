...
<div class="section theme-green">
    ...
    <div class="req-grid">
        <div class="req-pill"><span class="num">1</span><div class="fr-content"><div class="fr-en">Rider Request Ride (pickup &rarr; drop)</div><div class="fr-hi">Ye sabse basic requirement hai — user app kholega, pickup aur drop location daalega aur ride request karega, bina iske toh Uber/Ola ka koi matlab hi nahi hai, ye pura system ka entry point hai</div></div></div>
        <div class="req-pill"><span class="num">2</span><div class="fr-content"><div class="fr-en">Driver-Rider Matching (nearest available)</div><div class="fr-hi">Ye feature isliye core hai taki rider ko sabse kareeb wala available driver mile — Uber ka pura business isi matching algorithm pe tikka hai, geospatial query se 3-5 km radius me drivers dhundhte hain aur best match assign karte hain</div></div></div>
        <div class="req-pill"><span class="num">3</span><div class="fr-content"><div class="fr-en">Real-time Location Tracking (WebSocket)</div><div class="fr-hi">Ye feature isliye hai taki rider ko map pe live dikhe ki driver kahan hai — WebSocket se har 2-3 second me location update hota hai, isse rider ko trust rehta hai aur wo pickup point pe sahi time pe pohoch sakta hai</div></div></div>
        <div class="req-pill"><span class="num">4</span><div class="fr-content"><div class="fr-en">Fare Estimation &amp; Surge Pricing</div><div class="fr-hi">Ye feature isliye hai taki user ko ride book karne se pehle pata chale kitna kharcha aayega — aur jab demand zyada ho toh surge pricing lagti hai jaise raat ko ya baarish me, isse drivers ko incentive milta hai online aane ka</div></div></div>
        <div class="req-pill"><span class="num">5</span><div class="fr-content"><div class="fr-en">Trip Lifecycle (request &rarr; match &rarr; pickup &rarr; ride &rarr; drop)</div><div class="fr-hi">Ye feature isliye hai taki ride ka har stage properly track ho — request kiya, driver mila, pickup pe pohoncha, ride start hui, drop pe pohoncha, ye state machine ensure karta hai ki koi invalid transition na ho jaise seedha drop pe nahi ja sakte bina pickup ke</div></div></div>
        <div class="req-pill"><span class="num">6</span><div class="fr-content"><div class="fr-en">ETA Calculation</div><div class="fr-hi">Ye feature isliye hai taki rider ko pata chale ki driver kitne minute me aayega — traffic conditions, distance aur route ke basis pe ETA calculate hota hai, Uber me ye information user experience ka key part hai</div></div></div>
        <div class="req-pill"><span class="num">7</span><div class="fr-content"><div class="fr-en">Driver Availability Management</div><div class="fr-hi">Ye feature isliye zaroori hai taki sirf available drivers ko hi ride requests bhejein — agar driver offline hai ya pehle se ride pe hai toh usse naya request nahi jaana chahiye, isse matching algorithm efficient rehta hai</div></div></div>
        <div class="req-pill"><span class="num">8</span><div class="fr-content"><div class="fr-en">Ride Pooling / Sharing</div><div class="fr-hi">Ye feature isliye hai taki same direction jaane wale riders ek cab share kar sakein — isse rider ko sasta padta hai aur driver ko zyada earning hoti hai, Uber Pool aur Ola Share me yahi concept hai</div></div></div>
        <div class="req-pill"><span class="num">9</span><div class="fr-content"><div class="fr-en">Cancellation Policy &amp; Fees</div><div class="fr-hi">Ye feature isliye hai taki frivolous cancellations pe control rahe — driver ne time aur fuel waste kiya agar rider ne last minute cancel kiya, isliye free window ke baad cancellation fee lagti hai jo driver ko compensate karti hai</div></div></div>
        <div class="req-pill"><span class="num">10</span><div class="fr-content"><div class="fr-en">Rating &amp; Review System</div><div class="fr-hi">Ye feature isliye hai taki quality control rahe — rider driver ko rate karega toh bad drivers filter ho jayenge, aur driver rider ko rate karega toh misbehaving riders ko bhi track kar sakte hain, Uber me 4.5 se neeche rating wale drivers ko deactivate karte hain</div></div></div>
        <div class="req-pill"><span class="num">11</span><div class="fr-content"><div class="fr-en">Payment Integration</div><div class="fr-hi">Ye feature isliye hai taki ride complete hone pe seamless payment ho — cash ke alawa UPI, Card, Wallet sab options hone chahiye, cashless rides se driver ko exact change ki tension nahi hoti aur company ka commission bhi automatically cut hota hai</div></div></div>
        <div class="req-pill"><span class="num">12</span><div class="fr-content"><div class="fr-en">SOS / Emergency Support</div><div class="fr-hi">Ye feature isliye hai taki rider ki safety ensure ho — agar ride me kuch galat lage toh ek button dabane se family ko live location jayegi aur nearest police ko alert jayega, ye safety feature regulatory compliance ke liye bhi mandatory hai</div></div></div>
    </div>
</div>
