...
<div class="section theme-green">
    ...
    <div class="req-grid">
        <div class="req-pill"><span class="num">1</span><div class="fr-content"><div class="fr-en">Payment Initiation (UPI / Card / Net Banking)</div><div class="fr-hi">Ye requirement isliye hai taki user apne preferred method se payment kar sake — UPI, Card, Net Banking sab support hona chahiye kyunki India me har user alag method use karta hai</div></div></div>
        <div class="req-pill"><span class="num">2</span><div class="fr-content"><div class="fr-en">Payment Gateway Integration (Razorpay / Stripe)</div><div class="fr-hi">Ye feature isliye hai taki hum directly banks se deal na karein — Razorpay/Stripe jaisi gateways payment processing ka heavy lifting handle karti hain, humein sirf integrate karna hai</div></div></div>
        <div class="req-pill"><span class="num">3</span><div class="fr-content"><div class="fr-en">Idempotency (prevent double charge)</div><div class="fr-hi">Ye sabse critical requirement hai — agar user ne galti se 2 baar pay button dabaya toh uska paisa double cut nahi hona chahiye, idempotency key se ensure hota hai ki same request dubara process nahi hogi</div></div></div>
        <div class="req-pill"><span class="num">4</span><div class="fr-content"><div class="fr-en">Wallet System (top-up, debit, balance)</div><div class="fr-hi">Ye feature isliye hai taki user apna paisa wallet me rakh sake aur instantly payment kar sake — refund bhi wallet me aata hai, jisse user ko bank transfer ka wait nahi karna padta</div></div></div>
        <div class="req-pill"><span class="num">5</span><div class="fr-content"><div class="fr-en">Full &amp; Partial Refunds</div><div class="fr-hi">Ye feature isliye zaroori hai kyunki order cancel ya return hone pe user ko paisa wapas milna chahiye — kabhi full refund hota hai kabhi partial, dono handle karna padta hai</div></div></div>
        <div class="req-pill"><span class="num">6</span><div class="fr-content"><div class="fr-en">Ledger / Double-Entry Bookkeeping</div><div class="fr-hi">Ye feature isliye hai taki har paisa ka hisaab rahe — double-entry bookkeeping se har transaction me debit aur credit dono record hote hain, audit aur reconciliation ke liye ye backbone hai</div></div></div>
        <div class="req-pill"><span class="num">7</span><div class="fr-content"><div class="fr-en">Webhook Handling (async status updates)</div><div class="fr-hi">Ye feature isliye hai kyunki payment gateway turant result nahi deta — UPI ya net banking me user bank app pe jaata hai, jab payment complete hota hai toh gateway webhook se humein batata hai ki paisa aaya ya nahi</div></div></div>
        <div class="req-pill"><span class="num">8</span><div class="fr-content"><div class="fr-en">Reconciliation (daily settlement matching)</div><div class="fr-hi">Ye feature isliye hai taki humara paisa kabhi kho na jaye — daily gateway ke records ko apne records se match karte hain, agar koi mismatch mila toh turant flag hota hai aur investigate karte hain</div></div></div>
        <div class="req-pill"><span class="num">9</span><div class="fr-content"><div class="fr-en">Fraud Detection (velocity checks, amount limits)</div><div class="fr-hi">Ye feature isliye zaroori hai taki stolen cards ya fake accounts se fraud na ho sake — agar koi 1 minute me 50 transactions kar raha hai ya unusual amount hai toh system turant block kare</div></div></div>
        <div class="req-pill"><span class="num">10</span><div class="fr-content"><div class="fr-en">PCI-DSS Compliance (tokenized card storage)</div><div class="fr-hi">Ye compliance requirement hai — raw card number kabhi store nahi karna chahiye, tokenize karke rakhna padta hai warna RBI aur PCI-DSS rules ka violation hota hai aur company pe heavy fine lag sakta hai</div></div></div>
        <div class="req-pill"><span class="num">11</span><div class="fr-content"><div class="fr-en">Multi-Currency Support</div><div class="fr-hi">Ye feature isliye hai taki international customers bhi payment kar sakein — ek US user USD me pay karega, Indian user INR me, system ko real-time exchange rate se conversion handle karna padta hai</div></div></div>
        <div class="req-pill"><span class="num">12</span><div class="fr-content"><div class="fr-en">Payment State Machine (lifecycle tracking)</div><div class="fr-hi">Ye feature isliye hai taki payment ka har stage pata chale — INITIATED se CAPTURED ya FAILED tak, state machine ensure karta hai ki invalid transitions na ho jaise directly INITIATED se REFUNDED nahi ja sakta</div></div></div>
    </div>
</div>
