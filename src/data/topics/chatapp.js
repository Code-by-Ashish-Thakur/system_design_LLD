...
<div class="section theme-green">
    ...
    <div class="req-grid">
        <div class="req-pill"><span class="num">1</span><div class="fr-content"><div class="fr-en">Create Chat Rooms (Private/Group/Channel)</div><div class="fr-hi">Ye sabse fundamental requirement hai — bina rooms ke chat kaise hogi? Private 1-on-1 ke liye, Group friends/team ke liye, aur Channel broadcast ke liye chahiye jaise Slack/Discord me hota hai</div></div></div>
        <div class="req-pill"><span class="num">2</span><div class="fr-content"><div class="fr-en">Send &amp; Receive Messages</div><div class="fr-hi">Ye core feature hai — chat app ka poora purpose hi yahi hai ki user text, emoji, ya media bhej sake aur doosra user ko instantly mile. Bina iske chat app exist hi nahi karti</div></div></div>
        <div class="req-pill"><span class="num">3</span><div class="fr-content"><div class="fr-en">Message History with Pagination</div><div class="fr-hi">Ye isliye zaroori hai ki user purani conversation dekh sake — agar saare messages ek saath load karenge toh app hang ho jaayega, isliye pagination lagaate hai scroll up pe</div></div></div>
        <div class="req-pill"><span class="num">4</span><div class="fr-content"><div class="fr-en">Real-time Messaging via WebSocket</div><div class="fr-hi">Ye sabse critical requirement hai — chat me 1-2 second ki delay bhi acceptable nahi hai. HTTP polling se server pe unnecessary load padega, isliye WebSocket persistent connection rakhta hai taki messages turant deliver ho</div></div></div>
        <div class="req-pill"><span class="num">5</span><div class="fr-content"><div class="fr-en">File/Attachment Upload</div><div class="fr-hi">Ye feature isliye hai taki user sirf text nahi, balki images, PDFs, documents bhi share kar sake — modern chat me file sharing ke bina kaam nahi chalta, WhatsApp/Slack sab me hai</div></div></div>
        <div class="req-pill"><span class="num">6</span><div class="fr-content"><div class="fr-en">Typing Indicator</div><div class="fr-hi">Ye UX feature hai taki doosre user ko pata chale ki saamne wala reply type kar raha hai — bina iske user sochega ki message ignore ho gaya. WhatsApp ka "typing..." indicator isi liye exist karta hai</div></div></div>
        <div class="req-pill"><span class="num">7</span><div class="fr-content"><div class="fr-en">Online/Offline Presence</div><div class="fr-hi">Ye feature isliye chahiye taki user ko pata chale ki doosra banda abhi available hai ya nahi — agar offline hai toh message ka reply ka wait karna padega, green dot dikhne se user ko instant feedback milta hai</div></div></div>
        <div class="req-pill"><span class="num">8</span><div class="fr-content"><div class="fr-en">Search Messages</div><div class="fr-hi">Bina search ke purana message dhundhna impossible hai — soch agar 6 mahine pehle kisi ne ek link bheja tha, bina search ke hazaaron messages scroll karne padenge. Ye productivity ke liye must-have hai</div></div></div>
        <div class="req-pill"><span class="num">9</span><div class="fr-content"><div class="fr-en">Room-based Broadcasting</div><div class="fr-hi">Ye group chat ka backbone hai — jab ek user message bheje toh room ke saare members ko simultaneously milna chahiye. Bina room-based broadcast ke group chat kaam hi nahi karegi</div></div></div>
        <div class="req-pill"><span class="num">10</span><div class="fr-content"><div class="fr-en">Read Receipts</div><div class="fr-hi">Ye feature isliye hai taki sender ko pata chale ki receiver ne message padha ya nahi — WhatsApp ke blue ticks jaisa. Professional chats me ye bohot important hai, pata chalta hai ki saamne wale ne dekha ya nahi</div></div></div>
        <div class="req-pill"><span class="num">11</span><div class="fr-content"><div class="fr-en">User Mentions &amp; Notifications</div><div class="fr-hi">Group chat me 50-100 messages aa sakte hai, har ek padhna mushkil hai — @mention se specific user ko directly tag karke notification jaata hai taki important message miss na ho, Slack me ye daily use hota hai</div></div></div>
        <div class="req-pill"><span class="num">12</span><div class="fr-content"><div class="fr-en">Join/Leave Room</div><div class="fr-hi">Ye room management ke liye zaroori hai — user ko freedom honi chahiye ki woh kisi bhi room me join ya leave kar sake, aur baaki members ko pata chale ki kaun aaya aur kaun gaya</div></div></div>
        <div class="req-pill"><span class="num">13</span><div class="fr-content"><div class="fr-en">Pin/Unpin Messages</div><div class="fr-hi">Group me important decisions, links ya announcements scroll me kho jaate hai — pin karne se ye messages always top pe accessible rehte hai. Discord/Slack me ye feature bohot use hota hai team coordination ke liye</div></div></div>
        <div class="req-pill"><span class="num">14</span><div class="fr-content"><div class="fr-en">Offline Message Sync</div><div class="fr-hi">Ye isliye zaroori hai ki agar user ka internet chala gaya ya phone band tha, toh wapas aane pe saare pending messages mil jaaye — koi bhi message lost nahi hona chahiye, warna chat app pe trust khatam ho jaayega</div></div></div>
    </div>
</div>
