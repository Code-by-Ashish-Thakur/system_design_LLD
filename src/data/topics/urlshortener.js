...
<div class="section theme-green">
    ...
    <div class="req-grid">
        <div class="req-pill"><span class="num">1</span><div class="fr-content"><div class="fr-en">Shorten a long URL</div><div class="fr-hi">Ye poore system ka core purpose hai — lambi ugly URL ko ek chhoti shareable link me convert karna. Social media pe character limit hoti hai, aur lambi URL dekhne me bhi kharab lagti hai</div></div></div>
        <div class="req-pill"><span class="num">2</span><div class="fr-content"><div class="fr-en">Redirect short URL to original</div><div class="fr-hi">Ye sabse critical requirement hai — agar short URL click karne pe original page pe nahi jaayega toh poora system bekar hai. 301/302 redirect se user ko seamlessly original destination pe le jaana hai</div></div></div>
        <div class="req-pill"><span class="num">3</span><div class="fr-content"><div class="fr-en">Custom alias support</div><div class="fr-hi">Ye feature isliye hai taki user readable aur branded links bana sake — jaise bit.ly/summer-sale random hash se zyada professional lagta hai aur yaad bhi rehta hai</div></div></div>
        <div class="req-pill"><span class="num">4</span><div class="fr-content"><div class="fr-en">URL expiration (TTL)</div><div class="fr-hi">Har URL permanent nahi honi chahiye — promotional campaigns, temporary links ke liye expiry set karna zaroori hai. TTL ke baad URL auto-deactivate ho jaaye taki database me dead links accumulate na ho</div></div></div>
        <div class="req-pill"><span class="num">5</span><div class="fr-content"><div class="fr-en">Click analytics tracking</div><div class="fr-hi">Sirf URL chhoti karna kaafi nahi — marketers ko jaanna hai kitne log click kar rahe hai, kaunse country se, kaunse device se. Ye analytics hi hai jo URL shortener ko Bitly jaisa valuable product banaati hai</div></div></div>
        <div class="req-pill"><span class="num">6</span><div class="fr-content"><div class="fr-en">User registration &amp; auth</div><div class="fr-hi">Bina auth ke user apni URLs manage nahi kar paayega — login se user ko apni saari URLs ek jagah milti hai, analytics dekhne milta hai, aur abuse se protection milta hai</div></div></div>
        <div class="req-pill"><span class="num">7</span><div class="fr-content"><div class="fr-en">List user's URLs (paginated)</div><div class="fr-hi">Ye dashboard feature hai — user ne 500 URLs banayi hai toh saari ek saath load nahi kar sakte, pagination se page by page dikhaao. User ko apni links manage karne ka control milna chahiye</div></div></div>
        <div class="req-pill"><span class="num">8</span><div class="fr-content"><div class="fr-en">Delete / deactivate a URL</div><div class="fr-hi">Agar koi URL galat jagah point kar rahi hai ya campaign khatam ho gaya, toh user ko delete/deactivate ka option milna chahiye — warna malicious use bhi ho sakta hai aur user ka koi control nahi hoga</div></div></div>
        <div class="req-pill"><span class="num">9</span><div class="fr-content"><div class="fr-en">Rate limiting per user</div><div class="fr-hi">Bina rate limit ke ek spammer millions of URLs bana ke system abuse kar sakta hai — rate limiting se fair usage ensure hota hai aur database ko spam entries se protect karte hai</div></div></div>
        <div class="req-pill"><span class="num">10</span><div class="fr-content"><div class="fr-en">Bulk URL creation via API</div><div class="fr-hi">Enterprise customers ko ek baar me 1000+ URLs generate karne padte hai — marketing campaigns ke liye. Ek ek karke banana impractical hai, isliye bulk API endpoint dena zaroori hai</div></div></div>
    </div>
</div>
